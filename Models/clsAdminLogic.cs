...
namespace SportsBattle.Models
{
    ...
    public class clsAdminLogic
    {
        ...
        public DataTable SaveCommissionDetail(CommissionDetailsModel details)
        {
            DataTable dt = new DataTable();

            SqlParameter[] parm = new SqlParameter[]
            {
        new SqlParameter("@Action", details.Action ?? (object)DBNull.Value),
        new SqlParameter("@entryby", details.EntryBy ?? (object)DBNull.Value),
        new SqlParameter("@Id", details.Id ?? (object)DBNull.Value),
        new SqlParameter("@UseriD", details.UserId ?? (object)DBNull.Value),
        new SqlParameter("@dmt", details.DMT ?? (object)DBNull.Value),
        new SqlParameter("@dmttfrom1", details.DMTTFrom1 ?? (object)DBNull.Value),
        new SqlParameter("@dmttto1", details.DMTTTo1 ?? (object)DBNull.Value),
        new SqlParameter("@dmtTypeOfCommission1", details.DMTTypeOfCommission1 ?? (object)DBNull.Value),
        new SqlParameter("@dmtfees1", details.DMTFees1 ?? (object)DBNull.Value),
        new SqlParameter("@dmttfrom2", details.DMTTFrom2 ?? (object)DBNull.Value),
        new SqlParameter("@dmttto2", details.DMTTTo2 ?? (object)DBNull.Value),
        new SqlParameter("@dmtTypeOfCommission2", details.DMTTypeOfCommission2 ?? (object)DBNull.Value),
        new SqlParameter("@dmtfees2", details.DMTFees2 ?? (object)DBNull.Value),
        new SqlParameter("@dmttfrom3", details.DMTTFrom3 ?? (object)DBNull.Value),
        new SqlParameter("@dmttto3", details.DMTTTo3 ?? (object)DBNull.Value),
        new SqlParameter("@dmtTypeOfCommission3", details.DMTTypeOfCommission3 ?? (object)DBNull.Value),
        new SqlParameter("@dmtfees3", details.DMTFees3 ?? (object)DBNull.Value),
        new SqlParameter("@AEPS", details.AEPS ?? (object)DBNull.Value),
        new SqlParameter("@AEPStfrom1", details.AEPSTFrom1 ?? (object)DBNull.Value),
        new SqlParameter("@AEPStto1", details.AEPSTTo1 ?? (object)DBNull.Value),
        new SqlParameter("@AEPSTTypeOfCommission1", details.AEPSTypeOfCommission1 ?? (object)DBNull.Value),
        new SqlParameter("@AEPSfees1", details.AEPSFees1 ?? (object)DBNull.Value),
        new SqlParameter("@AEPtfrom2", details.AEPSTFrom2 ?? (object)DBNull.Value),
        new SqlParameter("@AEPStto2", details.AEPSTTo2 ?? (object)DBNull.Value),
        new SqlParameter("@AEPSTTypeOfCommission2", details.AEPSTypeOfCommission2 ?? (object)DBNull.Value),
        new SqlParameter("@AEPSfees2", details.AEPSFees2 ?? (object)DBNull.Value),
        new SqlParameter("@AEPtfrom3", details.AEPSTFrom3 ?? (object)DBNull.Value),
        new SqlParameter("@AEPStto3", details.AEPSTTo3 ?? (object)DBNull.Value),
        new SqlParameter("@AEPSTTypeOfCommission3", details.AEPSTypeOfCommission3 ?? (object)DBNull.Value),
        new SqlParameter("@AEPSfees3", details.AEPSFees3 ?? (object)DBNull.Value),
        new SqlParameter("@AEPtfrom4", details.AEPSTFrom4 ?? (object)DBNull.Value),
        new SqlParameter("@AEPStto4", details.AEPSTTo4 ?? (object)DBNull.Value),
        new SqlParameter("@AEPSTTypeOfCommission4", details.AEPSTypeOfCommission4 ?? (object)DBNull.Value),
        new SqlParameter("@AEPSfees4", details.AEPSFees4 ?? (object)DBNull.Value),
        new SqlParameter("@MATM", details.MATM ?? (object)DBNull.Value),
        new SqlParameter("@MATMtfrom1", details.MATMTFrom1 ?? (object)DBNull.Value),
        new SqlParameter("@MATMtto1", details.MATMTTo1 ?? (object)DBNull.Value),
        new SqlParameter("@MATMypeOfCommission1", details.MATMTypeOfCommission1 ?? (object)DBNull.Value),
        new SqlParameter("@MATMfees1", details.MATMFees1 ?? (object)DBNull.Value),
        new SqlParameter("@MATMtfrom2", details.MATMTFrom2 ?? (object)DBNull.Value),
        new SqlParameter("@MATMtto2", details.MATMTTo2 ?? (object)DBNull.Value),
        new SqlParameter("@MATMypeOfCommission2", details.MATMTypeOfCommission2 ?? (object)DBNull.Value),
        new SqlParameter("@MATMfees2", details.MATMFees2 ?? (object)DBNull.Value),
        new SqlParameter("@MATMtfrom3", details.MATMTFrom3 ?? (object)DBNull.Value),
        new SqlParameter("@MATMtto3", details.MATMTTo3 ?? (object)DBNull.Value),
        new SqlParameter("@MATMypeOfCommission3", details.MATMTypeOfCommission3 ?? (object)DBNull.Value),
        new SqlParameter("@MATMfees3", details.MATMFees3 ?? (object)DBNull.Value),
        new SqlParameter("@MATMtfrom4", details.MATMTFrom4 ?? (object)DBNull.Value),
        ...
        new SqlParameter("@Recharge", details.Recharge ?? (object)DBNull.Value),
        new SqlParameter("@Airtel", details.Airtel ?? (object)DBNull.Value),
        new SqlParameter("@Airteloneormore", details.AirtelOneOrMore ?? (object)DBNull.Value),
        new SqlParameter("@AirteltransactionAmount", details.AirtelTransactionAmount ?? (object)DBNull.Value),
        new SqlParameter("@AirtelypeOfCommission", details.AirtelTypeOfCommission ?? (object)DBNull.Value),
        new SqlParameter("@Airtelfees", details.AirtelFees ?? (object)DBNull.Value),
        new SqlParameter("@BSNL", details.BSNL ?? (object)DBNull.Value),
        new SqlParameter("@BSNLoneormore", details.BSNLOneOrMore ?? (object)DBNull.Value),
        new SqlParameter("@BSNLtransactionAmount", details.BSNLTransactionAmount ?? (object)DBNull.Value),
        new SqlParameter("@BSNLypeOfCommission", details.BSNLTypeOfCommission ?? (object)DBNull.Value),
        new SqlParameter("@BSNLfees", details.BSNLFees ?? (object)DBNull.Value),
        new SqlParameter("@JIO", details.JIO ?? (object)DBNull.Value),
        new SqlParameter("@JIOoneormore", details.JIOOneOrMore ?? (object)DBNull.Value),
        new SqlParameter("@JIOtransactionAmount", details.JIOTransactionAmount ?? (object)DBNull.Value),
        new SqlParameter("@JIOypeOfCommission", details.JIOTypeOfCommission ?? (object)DBNull.Value),
        new SqlParameter("@JIOfees", details.JIOFees ?? (object)DBNull.Value),
        new SqlParameter("@VodafoneIdea", details.VodafoneIdea ?? (object)DBNull.Value),
        new SqlParameter("@VodafoneIdeaoneormore", details.VodafoneIdeaOneOrMore ?? (object)DBNull.Value),
        new SqlParameter("@VodafoneIdeatransactionAmount", details.VodafoneIdeaTransactionAmount ?? (object)DBNull.Value),
        new SqlParameter("@VodafoneIdeaypeOfCommission", details.VodafoneIdeaTypeOfCommission ?? (object)DBNull.Value),
        new SqlParameter("@VodafoneIdeafees", details.VodafoneIdeaFees ?? (object)DBNull.Value),
        new SqlParameter("@DTH", details.DTH ?? (object)DBNull.Value),
        new SqlParameter("@AIRTELDTH", details.AIRTELDTH ?? (object)DBNull.Value),
        new SqlParameter("@AIRTELDTHoneormore", details.AIRTELDTHOneOrMore ?? (object)DBNull.Value),
        new SqlParameter("@AIRTELDTHtransactionAmount", details.AIRTELDTHTransactionAmount ?? (object)DBNull.Value),
        new SqlParameter("@AIRTELDTHtypeOfCommission", details.AIRTELDTHTypeOfCommission ?? (object)DBNull.Value),
        new SqlParameter("@AIRTELDTHfees", details.AIRTELDTHFees ?? (object)DBNull.Value),
        new SqlParameter("@DISHTV", details.DISHTV ?? (object)DBNull.Value),
        new SqlParameter("@DISHTVoneormore", details.DISHTVOneOrMore ?? (object)DBNull.Value),
        new SqlParameter("@DISHTVtransactionAmount", details.DISHTVTransactionAmount ?? (object)DBNull.Value),
        new SqlParameter("@DISHTVtypeOfCommission", details.DISHTVTypeOfCommission ?? (object)DBNull.Value),
        new SqlParameter("@DISHTVfees", details.DISHTVFees ?? (object)DBNull.Value),
        new SqlParameter("@SUNTV", details.SUNTV ?? (object)DBNull.Value),
        new SqlParameter("@SUNTVoneormore", details.SUNTVOneOrMore ?? (object)DBNull.Value),
        new SqlParameter("@SUNTVtransactionAmount", details.SUNTVTransactionAmount ?? (object)DBNull.Value),
        new SqlParameter("@SUNTVtypeOfCommission", details.SUNTVTypeOfCommission ?? (object)DBNull.Value),
        new SqlParameter("@SUNTVfees", details.SUNTVFees ?? (object)DBNull.Value),
        new SqlParameter("@TATASKY", details.TATASKY ?? (object)DBNull.Value),
        new SqlParameter("@TATASKYoneormore", details.TATASKYOneOrMore ?? (object)DBNull.Value),
        new SqlParameter("@TATASKYtransactionAmount", details.TATASKYTransactionAmount ?? (object)DBNull.Value),
        new SqlParameter("@TATASKYtypeOfCommission", details.TATASKYTypeOfCommission ?? (object)DBNull.Value),
        new SqlParameter("@TATASKYfees", details.TATASKYFees ?? (object)DBNull.Value),
        new SqlParameter("@VIDEOCONDTH", details.VIDEOCONDTH ?? (object)DBNull.Value),
        new SqlParameter("@VIDEOCONDTHoneormore", details.VIDEOCONDTHOneOrMore ?? (object)DBNull.Value),
        new SqlParameter("@VIDEOCONDTHtransactionAmount", details.VIDEOCONDTHTransactionAmount ?? (object)DBNull.Value),
        new SqlParameter("@VIDEOCONDTHtypeOfCommission", details.VIDEOCONDTHTypeOfCommission ?? (object)DBNull.Value),
        new SqlParameter("@VIDEOCONDTHfees", details.VIDEOCONDTHFees ?? (object)DBNull.Value),
        new SqlParameter("@FASTAG", details.FASTAG ?? (object)DBNull.Value),
        ...
        new SqlParameter("@LICtransactionAmount", details.LICTransactionAmount ?? (object)DBNull.Value),
        new SqlParameter("@LICtypeOfCommission", details.LICTypeOfCommission ?? (object)DBNull.Value),
        new SqlParameter("@LICfees", details.LICFees ?? (object)DBNull.Value),
        new SqlParameter("@PAN", details.PAN ?? (object)DBNull.Value),
        new SqlParameter("@PANoneormore", details.PANOneOrMore ?? (object)DBNull.Value),
        new SqlParameter("@PANtransactionAmount", details.PANTransactionAmount ?? (object)DBNull.Value),
        new SqlParameter("@PANtypeOfCommission", details.PANTypeOfCommission ?? (object)DBNull.Value),
        new SqlParameter("@PANfees", details.PANFees ?? (object)DBNull.Value),
        new SqlParameter("@EPFO", details.EPFO ?? (object)DBNull.Value),
        new SqlParameter("@EPFOoneormore", details.EPFOOneOrMore ?? (object)DBNull.Value),
        new SqlParameter("@EPFOtransactionAmount", details.EPFOTransactionAmount ?? (object)DBNull.Value),
        new SqlParameter("@EPFOtypeOfCommission", details.EPFOTypeOfCommission ?? (object)DBNull.Value),
        new SqlParameter("@EPFOfees", details.EPFOFees ?? (object)DBNull.Value),
        new SqlParameter("@EPFOtypeOfCommission12", details.EPFOTypeOfCommission12 ?? (object)DBNull.Value),
